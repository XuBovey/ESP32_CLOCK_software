...
bool key_values[3] = {0};
uint8_t keu_num[]={GPIO_INPUT_IO_0, GPIO_INPUT_IO_1, GPIO_INPUT_IO_2};
...
{
	return key_values[num];
//    return gpio_get_level(keu_num[num])==0?true:false;
}
