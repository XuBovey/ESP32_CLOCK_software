...
void setup_scr_main(lv_ui *ui){
	...
	lv_style_set_radius(&style_main_back_main, LV_STATE_DEFAULT, 0);
	lv_style_set_bg_color(&style_main_back_main, LV_STATE_DEFAULT, lv_color_make(0xbe, 0xbe, 0x00));
	lv_style_set_bg_grad_color(&style_main_back_main, LV_STATE_DEFAULT, lv_color_make(0xbe, 0xbe, 0x00));
	...
	lv_style_set_border_color(&style_main_back_main, LV_STATE_DEFAULT, lv_color_make(0x99, 0x99, 0x99));
	...
	lv_style_set_text_font(&style_main_label_time_main, LV_STATE_DEFAULT, &lv_font_montserratMedium_24);
	...
	lv_obj_set_pos(ui->main_label_time, 0, 180);
	...
	lv_style_set_text_font(&style_main_label_temp_main, LV_STATE_DEFAULT, &lv_font_montserratMedium_24);
	...
	lv_style_set_text_font(&style_main_label_humidity_main, LV_STATE_DEFAULT, &lv_font_montserratMedium_24);
